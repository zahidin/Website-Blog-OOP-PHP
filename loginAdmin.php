...
if( isset($_POST['submit']) )
{
	if( Token::check( Input::get('token')) )
	{
		...
		if( $validation->passed() )
		{
			...
			{
				if( $user->login_admin( Input::get('username') , Input::get('password') ))
				{
				...
				$errors[] = "Maaf username anda buka admin";
			}
		}else{
...
<html>
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/loginadmin/css/loginyeti.css">
  ...
  <body>
    ...
    <script src="assets/loginadmin/js/loginyeti.js"></script>
