 ...
 * @return name Operating System*/
 ...
 function insert_statik($fields = array())
 {
   if ($this->_db->insert('statik_pengunjung', $fields)) return true;
   else return false;
 }
 ...
 function list_table_like($table,$column,$value)
 {
   $data = $this->_db->like($table,$column,$value);
   return $data;
 }
